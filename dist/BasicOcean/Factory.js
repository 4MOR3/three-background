...
var BasicOceanFactory = /** @class */ (function () {
    function BasicOceanFactory(dom) {
        var _this = this;
    ...
    BasicOceanFactory.prototype.animate = function () {
        var _this = this;
    ...
    BasicOceanFactory.prototype.resize = function () {
    ...
    BasicOceanFactory.prototype.mousemove = function (e) {
        this.mouseX = e.clientX - this.winWidth / 2;
        this.mouseY = e.clientY - this.winWidth / 2;
    };
    BasicOceanFactory.prototype.destructor = function () {
     ...
     */
    BasicOceanFactory.prototype.freeUp = function (obj) {
        var _this = this;
        cancelAnimationFrame(this.reqId);
    ...
    BasicOceanFactory.prototype.genSky = function () {
        ...
        if (time >= 7 && time < 19) {
            ...
            this.camCtrl.set(-22, 367, 3.5);
            this.camera.lookAt(this.camCtrl);
        }
        else {
            this.camCtrl.set(-22, 43, -13);
            this.camera.lookAt(this.camCtrl);
    ...
    return BasicOceanFactory;
}());
;
exports.default = BasicOceanFactory;
